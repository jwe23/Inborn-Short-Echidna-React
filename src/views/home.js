...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Inborn Short Echidna</title>
        <meta property="og:title" content="Inborn Short Echidna" />
      </Helmet>
      <div className="home-header">
        ...
        >
          <span className="logo">SAASIFY</span>
          ...
          <div className="home-container01">
            ...
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>
                    Boost efficiency and productivity with our cutting-edge
                    software
                  </span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            ...
            <div className="home-container03">
              ...
              <FeatureCard
                ...
                subHeading="Track your data instantly for informed decisions"
              ></FeatureCard>
              <FeatureCard
                heading="Customizable Templates"
                subHeading="Tailor the platform to suit your brand"
              ></FeatureCard>
              <FeatureCard
                heading="Secure Data Encryption"
                subHeading="Protect your information with top-notch security measures"
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>
                  Select the plan that best fits your needs and unlock a world
                  of possibilities
                </span>
              </span>
            </span>
          ...
          <div className="home-container05">
            <div className="freePricingCard home-pricing-card">
              ...
              <div className="home-container08">
                <div className="home-container09">
                  ...
                  <span className="bodySmall">Limited access to all tools</span>
                </div>
                ...
                <div className="home-container11">
                  ...
                  <span className="bodySmall">Up to 5 projects</span>
                </div>
                <div className="home-container12">
                  <span className="home-text43">✔</span>
                  <span className="bodySmall">Monthly updates</span>
                </div>
              </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              ...
              <div className="home-container15">
                ...
                <div className="home-container17">
                  ...
                  <span className="bodySmall">Full access to all tools</span>
                </div>
                ...
                <div className="home-container19">
                  ...
                  <span className="bodySmall">Up to 20 projects</span>
                </div>
                <div className="home-container20">
                  <span className="home-text54">✔</span>
                  <span className="bodySmall">Weekly updates</span>
                </div>
              </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              <div className="home-container21">
                ...
                <span className="bodySmall">
                  Experience the full power of our platform with advanced
                  features
                </span>
              </div>
              ...
              <div className="home-container23">
                ...
                <div className="home-container28">
                  ...
                  <span className="bodySmall">Daily updates</span>
                </div>
              </div>
        ...
        <div className="bannerContainer home-banner1">
          ...
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Our Saas platform offers a seamless integration of tools to
                  optimize your operations. From project management to
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="We offer a flexible pricing model based on the number of users and features required. Contact us for a personalized quote."
                question="What is your pricing model?"
              ></Question1>
              <Question1
                answer="Yes, we offer a 14-day free trial for you to explore all the features and functionalities of our platform."
                question="Is there a free trial available?"
              ></Question1>
              <Question1
                answer="We take data security very seriously. Your data is encrypted and stored securely on our servers with regular backups to ensure its safety."
                question="How secure is my data on your platform?"
              ></Question1>
              <Question1
                answer="Yes, you can easily upgrade or downgrade your plan at any time to suit your changing needs. There are no long-term commitments."
                question="Can I upgrade or downgrade my plan at any time?"
              ></Question1>
              <Question1
                answer="Yes, we provide 24/7 customer support to assist you with any questions or issues you may have. Our team is dedicated to ensuring your success."
